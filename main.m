...
for i=1:size(Initial_position,2)
    [T,x_Sontag(:,:,i)] = ode45(@odefcn_Sontag,[0:t_sample:t_end],Initial_position(:,i));
end
...
for i=1:size(Initial_position,2)
    [T,x_Liyuandan(:,:,i)] = ode45(@odefcn_Liyuandan,[0:t_sample:t_end],Initial_position(:,i));
end
...
for i=1:size(Initial_position,2)
    [T,x_Ming_kappa1(:,:,i)] = ode45(@odefcn_Ming_kappa1,[0:t_sample:t_end],Initial_position(:,i));
end
...
for i=1:size(Initial_position,2)
    [T,x_Ming_kappa2(:,:,i)] = ode45(@odefcn_Ming_kappa2,[0:t_sample:t_end],Initial_position(:,i));
end
a_x=-x_Ming_kappa2(:,1,i).^4-x_Ming_kappa2(:,2,i).^2;
b_x=[x_Ming_kappa2(:,1,i).*exp(x_Ming_kappa2(:,2,i)),x_Ming_kappa2(:,2,i)].';
norm_b_vec=vecnorm(b_x,2,1).';
sigma_x=sqrt(a_x.^2+norm_b_vec.^4);
phi=norm_b_vec.^2.*sqrt(1+norm_b_vec.^2);
...
for i=1:size(Initial_position,2)
    [T,x_Ming_kappa3(:,:,i)] = ode45(@odefcn_Ming_kappa3,[0:t_sample:t_end],Initial_position(:,i));
end
...
for i=1:size(Initial_position,2)
    [T,x_Ming_optimization(:,:,i)] = ode45(@odefcn_Ming_optimization,[0:t_sample:t_end],Initial_position(:,i));
end
...
subplot(1,2,1)
for i=1:1:size(Initial_position,2)
    h_1(i)=plot(x_Sontag(1:t_plot_sample:end,1,i),x_Sontag(1:t_plot_sample:end,2,i),'r-','linewidth',1.5);
    hold on
    h_2(i)=plot(x_Liyuandan(1:t_plot_sample:end,1,i),x_Liyuandan(1:t_plot_sample:end,2,i),'m--','linewidth',1.5);
    h_3(i)=plot(x_Ming_kappa1(1:t_plot_sample:end,1,i),x_Ming_kappa1(1:t_plot_sample:end,2,i),'bv--','linewidth',1,'MarkerSize',4);
    h_4(i)=plot(x_Ming_kappa2(1:t_plot_sample:end,1,i),x_Ming_kappa2(1:t_plot_sample:end,2,i),'bp-','linewidth',1,'MarkerSize',4);
    h_5(i)=plot(x_Ming_kappa3(1:t_plot_sample:end,1,i),x_Ming_kappa3(1:t_plot_sample:end,2,i),'bo-','linewidth',1,'MarkerSize',4);
    h_6(i)=plot(x_Ming_optimization(1:t_plot_sample:end,1,i),x_Ming_optimization(1:t_plot_sample:end,2,i),'g+-','linewidth',1,'MarkerSize',4);
end
xlabel('$x_1$ (-)','interpreter','latex')
ylabel('$x_2$ (-)','interpreter','latex')
set(gca,'FontSize',17)
...
u_bound=ones(size(T,1),1);
for i=1:size(Initial_position,2)
    h_1(i)=plot(T(1:t_plot_sample:end),abs(u_Stg_norm(1:t_plot_sample:end)),'r-','linewidth',1.5);
    hold on
    h_2(i)=plot(T(1:t_plot_sample:end),abs(u_Lin_norm(1:t_plot_sample:end)),'m--','linewidth',1.5);
    h_3(i)=plot(T(1:t_plot_sample:end),abs(u_Ming_kappa1_norm(1:t_plot_sample:end)),'bv--','linewidth',1,'MarkerSize',4);
    h_4(i)=plot(T(1:t_plot_sample:end),abs(u_Ming_kappa2_norm(1:t_plot_sample:end)),'bp-','linewidth',1,'MarkerSize',4);
    h_5(i)=plot(T(1:t_plot_sample:end),abs(u_Ming_kappa3_norm(1:t_plot_sample:end)),'bo-','linewidth',1,'MarkerSize',4);
    h_6(i)=plot(T(1:t_plot_sample:end),abs(u_opt_nom(1:t_plot_sample:end)),'g+-','linewidth',1.5);
end
...
figure(2)
for i=1:1:size(Initial_position,2)
    h_2(i)=plot(T(1:t_plot_sample:t_end),cost_Lin(1:t_plot_sample:t_end),'m--','linewidth',1.5);
    hold on
    h_3(i)=plot(T(1:t_plot_sample:t_end),cost_kappa1(1:t_plot_sample:t_end),'bv--','linewidth',1,'MarkerSize',4);
    h_4(i)=plot(T(1:t_plot_sample:t_end),cost_kappa2(1:t_plot_sample:t_end),'bp-','linewidth',1,'MarkerSize',4);
    h_5(i)=plot(T(1:t_plot_sample:t_end),cost_kappa3(1:t_plot_sample:t_end),'bo-','linewidth',1,'MarkerSize',4);
    h_6(i)=plot(T(1:t_plot_sample:t_end),cost_optimization(1:t_plot_sample:t_end),'g+-','linewidth',1,'MarkerSize',4);
end
xlabel('$t$ (s)','interpreter','latex')
ylabel('Cost (-)')
set(gca,'FontSize',17)
